%olfactory_training_prot_v4
%run olfactory stimulation via an arduino
%for training the mice
%with fixed labeling for string issue
%LGG 10Aug18
...
filename = strcat('data_',date_str,'_mouse',mouse_group,mouse_id_str,'_training',day_of_training_str,'.mat');
save(filename, 'R')
